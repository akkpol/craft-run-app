...
|[feature-automation-owner-map-contract-1.md](feature-automation-owner-map-contract-1.md)|Scoped feature plan|You are locking state ownership, automation mode, and primary action surfaces before refactoring admin queues or adding event-driven automation|
|[feature-admin-overview-owner-cards-1.md](feature-admin-overview-owner-cards-1.md)|Scoped feature plan|You are refactoring the `/admin` overview inbox into owner-aware queue cards without touching separate admin pages or workflow behavior|
|[feature-admin-follow-up-owner-surface-1.md](feature-admin-follow-up-owner-surface-1.md)|Scoped feature plan|You are refactoring `/admin/follow-up` into an owner-aware follow-up surface while preserving the existing follow-up API behavior|
|[feature-admin-accounting-owner-surface-1.md](feature-admin-accounting-owner-surface-1.md)|Scoped feature plan|You are refactoring `/admin/accounting` into an owner-aware finance surface while preserving the existing export and commercial-document behavior|
|[feature-admin-prompts-owner-surface-1.md](feature-admin-prompts-owner-surface-1.md)|Scoped feature plan|You are refactoring `/admin/prompts` into an owner-aware prompt and preview workbench while preserving existing prompt/preview actions|
|[feature-studio-owner-inspector-1.md](feature-studio-owner-inspector-1.md)|Scoped feature plan|You are refining `/studio` so the inspector and operator layer explain owner, blocker, and next action using the workflow owner contract without rewriting the scene layout|
|[docs-flow-owner-map-quick-reference-1.md](docs-flow-owner-map-quick-reference-1.md)|Scoped documentation plan|You need the compact state/owner/automation/decision map before admin UI refactors, Figma mapping, or auto-run event work|
