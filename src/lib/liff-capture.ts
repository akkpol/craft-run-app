...
function normalizeAvailability(value: unknown): Record<string, LiffAvailabilitySnapshot> {
  ...
  return Object.fromEntries(
    Object.entries(record)
      ...
      .filter((entry): entry is readonly [string, LiffAvailabilitySnapshot] => Boolean(entry))
  );
}

export function normalizeLiffContextSnapshot(input: unknown): LiffContextSnapshot | null {
...
export function parseLiffContextSnapshot(rawValue: string | null | undefined): LiffContextSnapshot | null {
